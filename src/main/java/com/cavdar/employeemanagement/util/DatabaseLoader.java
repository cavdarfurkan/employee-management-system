...
public class DatabaseLoader implements CommandLineRunner {
    ...
    private void generateSampleEmployees(int numberOfEmployees) {
        ...
        List<String> lastNames = List.of("Newton", "Scott", "Jacob", "Leary", "Esparza", "Meredith", "Starr", "Lacy", "Cornett", "Plummer", "Lowery", "Nava", "Fischer", "Brantley", "Giles", "Reeves", "Horne", "McKinley", "Hagen", "Nash", "Bernard", "Barber", "Caudill", "Hinkle", "Rutledge", "Newell", "Link", "Franks", "Huber", "Thorne");
